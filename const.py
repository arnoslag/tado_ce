...
DEFAULT_ZONE_CONFIG = {
    ...
    "external_window_open_delay_minutes": 0,  # Minutes the window must stay open before Tado's
    # real open-window mode (heating pause) is actually triggered. 0 = immediate. Closing always reacts instantly.
