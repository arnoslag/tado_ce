...
class TadoCEOptionsFlow(config_entries.OptionsFlow):
    ...
    def _process_zone_sensor_input(
        ...
        if "sensor_section" in user_input:
            ...
            if use_ext_window:
                ...
                all_values["external_window_sensor"] = ""
            all_values["external_window_open_delay_minutes"] = s.get(
                "external_window_open_delay_minutes",
                existing.get("external_window_open_delay_minutes", 0),
            )
    ...
    async def async_step_zone_sensor_config(
        ...
        cur_window_open_delay = config.get("external_window_open_delay_minutes", 0)
